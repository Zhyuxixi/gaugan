...
# cmd_str = f'python spade_test.py --name bs4vae --dataset_mode custom --label_dir {args.input_path} --label_nc 29 --no_instance --use_vae --which_epoch 90 --no_pairing_check'
